...
def save_depth(depth, out_npy: Path, out_png: Path):
...
def main():
    ...
    img_path = PROJECT_ROOT / "data" / "dataset" / "train" / "olympus_macro_lens" / "needle1" / "jpg" / "burst_14.jpg"
    out_dir = PROJECT_ROOT / "outputs" / "depth_needle1"
    out_npy = out_dir / "burst_14_depth.npy"
    out_png = out_dir / "burst_14_depth.png"
